...
import BranchAdminSidebar from "./branch-admin-sidebar";
...
const BranchAdminLayout = () => {
  ...
  const handleMobileMenuStateChange = (state: any) => {
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="block lg:hidden">
            <BranchAdminMobileMenu
              ...
              handleIsOpen={handleMobileMenuToggle}
              handleStateChange={handleMobileMenuStateChange}
            />
          </div>
