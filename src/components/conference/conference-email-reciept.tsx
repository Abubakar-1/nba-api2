...
const ConferenceEmailReceipt = () => {
  ...
  async function getPaymentDetails(val: string) {
  ...
  useEffect(() => {
    if (searchParams.get("id")) {
      getPaymentDetails(searchParams.get("id") + "");
    } else navigate("/");
  }, [searchParams.get("id")]);
  ...
  return (
    <>
      <div className="px-5 mb-5 mt-10">
        <PageTitle title="Conference Email Receipt" />
        {viewPaymentRequest.isLoading ? (
          ...
          <div className="w-4/5">
            <div className="grid grid-cols-2 gap-5 text-sm">
              <h1 className="col-span-2 font-bold mb-7 text-lg lg:text-2xl">
              ...
              <div className="flex flex-col justify-center items-start gap-1">
                ...
                <p className="font-bold">{paymentInfo?.payer_email}</p>
              </div>
              <div className="flex flex-col justify-center items-start gap-1">
              ...
              <div className="col-span-2 mt-4 w-40">
                <Button variant="primary" dimension="lg" onClick={handlePrint}>
                  Download slip
                </Button>
              </div>
            </div>
...
export default ConferenceEmailReceipt;
