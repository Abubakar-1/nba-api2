...
type CheckboxInputProps = h.JSX.IntrinsicElements["input"] & {
  className?: string;
  dimension?: "xs" | "sm" | "md";
...
const Checkbox: FunctionalComponent<CheckboxInputProps> = ({
  variant = "primary",
  dimension = "sm",
  labelDescription,
  onClick,
  ...
  const classes = classNames("rounded", {
    ...
    "h-3 w-3 rounded": dimension === "xs",
    "h-4 w-4 rounded": dimension === "sm",
    "h-5 w-5 rounded": dimension === "md",
  });
