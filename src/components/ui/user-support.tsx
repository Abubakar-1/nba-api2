...
const UserSupport = ({
  ...
  //   setIsOpen(false);
  // };
  // Synchronize internal state with external trigger
  ...
  return (
    <div className="relative z-[70]">
      <Modal
        isOpen={isSupportModalOpen ?? isOpen}
      ...
      <div className="fixed right-2 bottom-3 lg:bottom-11 lg:right-12 w-fit">
        <div
        ...
        >
          {/* <p className="hidden font-medium lg:block text-gray-500">
            Contact support
          </p> */}
