...
const BranchDuesReceipt: FunctionalComponent = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: `${enrichedData?.recipient_name}-branch-dues-receipt`,
    pageStyle: pageStyle,
  });
  ...
  return (
    <div className="px-4">
      <PageTitle title="Branch Dues Receipt" />
...
export default BranchDuesReceipt;
